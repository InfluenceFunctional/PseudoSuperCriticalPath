...
#ifdef COMMAND_CLASS
// clang-format off
CommandStyle(change_box_mol,ChangeBoxMol);
// clang-format on
#else

#ifndef LMP_CHANGE_BOX_MOL_H
#define LMP_CHANGE_BOX_MOL_H

#include "command.h"

namespace LAMMPS_NS {

class ChangeBoxMol : public Command {
 public:
  ChangeBoxMol(class LAMMPS *);
  virtual ~ChangeBoxMol();
 ...
 protected:
  int nmolecules;
  double **rcm, *m_total, *m_proc, **mr_proc;
  void allocate(int);
};
